...
abstract class Singleton {
    ...
    public static function getInstance() {
        ...
        if( !isset( self::$_aInstance[$szClass] ) )
        {
            self::$_aInstance[$szClass] = new $szClass();
        }

        return self::$_aInstance[$szClass];
    }
    public static function isLoad($szClass=null) {
        return isset(self::$_aInstance[$szClass]) ? true:false;
    }

    public static function getInstanceList() {
        return array_keys(self::$_aInstance);
    }
